#
#  Be sure to run `pod spec lint ElephantTypeface.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Joycelee" => "1007521788@qq.com" }
  # Or just: spec.author    = "Barder"
  # spec.authors            = { "Barder" => "15001850846@163.com" }
  # spec.social_media_url   = "https://twitter.com/Barder"
  ...
  spec.source       = { :git => "https://github.com/joycelee720/ElephantTypeface.git", :tag => "#{spec.version}" }
  ...
  spec.resources = "*.ttf", "*.wav", "launchImg"
